...
namespace Poppy\Extension\Phpstan\Rules\ModelProperties;

use Illuminate\Database\Eloquent\Model;
use Illuminate\Database\Eloquent\Relations\BelongsToMany;
use Poppy\Extension\Phpstan\Types\ModelProperty\GenericModelPropertyType;
use Poppy\Extension\Phpstan\Types\ModelProperty\ModelPropertyType;
use PhpParser\Node;
