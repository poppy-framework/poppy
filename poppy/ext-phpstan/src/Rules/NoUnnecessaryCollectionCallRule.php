...
namespace Poppy\Extension\Phpstan\Rules;
...
use Poppy\Extension\Phpstan\Properties\ModelPropertyExtension;
use PhpParser\Node;
...
class NoUnnecessaryCollectionCallRule implements Rule
{
    ...
    /**
     * @var \Poppy\Extension\Phpstan\Properties\ModelPropertyExtension
     */
