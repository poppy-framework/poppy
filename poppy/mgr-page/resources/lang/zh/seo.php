...
* ---------------------------------------- */
    ...
    * ---------------------------------------- */
    ...
    'develop_api_json'             => '获取 JSON',
    'develop_pam_logout'           => '开发登出',
    'develop_clockwork_index'      => 'Clockwork',
    'develop_clockwork_report'     => 'Clockwork 报告',
    'develop_api_field'            => 'API字段',
    ...
    * ---------------------------------------- */
    ...
    'backend_captcha_send'         => '发送验证码',
    'backend_home_clear_cache'     => '清空缓存',
    'backend_home_easy-web'        => 'EasyWeb',
    'backend_pam_note'             => '设置备注',
    'backend_pam_mobile'           => '设置手机号',
    'backend_pam_clear_mobile'     => '清空手机号',
    'backend_pam_setting_log'      => '配置日志',
    'backend_pam_token'            => '用户凭据',
