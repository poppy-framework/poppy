...
@endif
@if (true)
    {!! Html::style('assets/libs/boot/style.css?v=2023-02-25') !!}
    {{--js--}}
    {!! Html::script('assets/libs/boot/vendor.min.js?v=2023-02-25') !!}
    {!! Html::script('assets/libs/boot/poppy.mgr.min.js?v=2023-02-25') !!}
