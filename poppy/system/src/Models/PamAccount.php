...
class PamAccount extends Model implements Authenticatable, JWTSubject, RbacUserContract
{
    ...
    /* Register By
     -------------------------------------------- */
    public const REG_TYPE_USERNAME = 'username';
    public const REG_TYPE_MOBILE   = 'mobile';
    public const REG_TYPE_EMAIL    = 'email';

    /* Guard Type
     -------------------------------------------- */
    public const GUARD_WEB         = 'web';
    public const GUARD_BACKEND     = 'backend';
    public const GUARD_JWT_BACKEND = 'jwt_backend';
    public const GUARD_JWT_WEB     = 'jwt_web';
    public const GUARD_JWT         = 'jwt';
     ...
     *
     * @return Model|object|PamAccount|null
     */
     ...
     * 获取定义的 kv 值
     *
     * @param string|null $key       需要获取的key, 默认返回整个定义
     ...
     * 获取定义的 kv 值
     *
     * @param string|int|null $key       需要获取的key, 默认返回整个定义
     * @param bool            $check_key 检测当前key 是否存在
     *
     * @return array|string
     */
