...
class StrHelper
{
    ...
    public function mdToc(string $content): array
    {
        ...
        foreach ($matches[0] as $item) {
            ...
            if (!trim($item_text) or false !== strpos($item_text, '|')) {
    ...
    public static function convert(string $str, $fromCharset = 'utf-8', $toCharset = 'gbk')
    {
        ...
        if ('utf-8' == $toCharset && self::isUtf8($str)) {
            return $str;
        }
        if ('gbk' == $toCharset && !self::isUtf8($str)) {
            return $str;
        }
    ...
    public static function fixLink(string $url)
    {
        ...
        return false === strpos($url, '://') ? 'http://' . $url : $url;
    }
